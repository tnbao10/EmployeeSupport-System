			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					<ul class="nav nav-secondary">
						...
						<li class="nav-item"><a 
							href="${pageContext.request.contextPath}/employee"> <i class="fas fa-user-tie"></i>
							Request History
						</a></li>

						<li class="nav-item"><a 
							href="${pageContext.request.contextPath}/employee?action=create-request"> <i class="fas fa-table"></i>
							Create Request
						</a></li>
					</ul>
				</div>
								...
								<ul class="dropdown-menu dropdown-user animated fadeIn">
									<div class="dropdown-user-scroll scrollbar-outer">
										<li>
											<div class="user-box">
												<div class="avatar-lg">
													<img src="assets/img/${sessionScope.photo}" 
														class="avatar-img rounded" />
												</div>
												<div class="u-text">
													<h4>${sessionScope.username}</h4>
													<p class="text-muted">${sessionScope.fullname}</p>
													<a href="${pageContext.request.contextPath}/employee?action=profile"
										...
										<li>
											...
											href="${pageContext.request.contextPath}/employee?action=logout">Logout</a>
										</li>
									</div>
								</ul></li>
						</ul>
