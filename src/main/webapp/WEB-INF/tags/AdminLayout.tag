			...
			<div class="sidebar-logo">
				...
				<div class="logo-header" data-background-color="dark">
					<a
						...
						href="${pageContext.request.contextPath}/admin" class="logo"> <img
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					<ul class="nav nav-secondary">
						...
						<li class="nav-item"><a 
							href="${pageContext.request.contextPath}/admin?action=employee-list"> <i class="fas fa-user-tie"></i>
							Employee List
						</a></li>

						<li class="nav-item"><a 
							href="${pageContext.request.contextPath}/admin?action=assignment"> <i class="fas fa-table"></i>
							Assignment
						</a></li>

						<li class="nav-item"><a
							href="${pageContext.request.contextPath}/admin?action=create-account"> <i class="fas fa-user"></i>
								<p>Create Account</p>
						</a></li>
					</ul>
				</div>
									...
									<li>
										<div class="message-notif-scroll scrollbar-outer">
											<div class="notif-center">
												<a href="#">
													<div class="notif-img">
														<img src="assets/img/admin.jpg" alt="Img Profile" />
													</div>
								...
								<ul class="dropdown-menu dropdown-user animated fadeIn">
									<div class="dropdown-user-scroll scrollbar-outer">
										<li>
											<div class="user-box">
												<div class="avatar-lg">
													<img src="assets/img/admin.jpg" alt="image profile"
														class="avatar-img rounded" />
												</div>
												<div class="u-text">
													<h4>${sessionScope.username}</h4>
													<p class="text-muted">${sessionScope.hoTen}</p>
													<a href="${pageContext.request.contextPath}/admin"
														class="btn btn-xs btn-secondary btn-sm">Home</a>
												</div>
											</div>
										</li>
										<li>
											<div class="dropdown-divider"></div> <a class="dropdown-item"
											href="${pageContext.request.contextPath}/admin?action=logout">Logout</a>
										</li>
									</div>
								</ul></li>
						</ul>
